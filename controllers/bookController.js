...
exports.book_list_p = asyncHandler(async (req,res,next)=>{
  const books_s = await Book.find({ title:{ $regex: req.body.searchBar , $options: 'i' }},"title author" )
  .sort({ title: 1 })
  .populate("author")
  .exec();
